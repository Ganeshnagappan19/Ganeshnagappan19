...
public class Byteprogram {
		...
		public static void main(String[] args) {
			...
			b=(byte)n;//n is converted to byte and the value also byte 8 bit and its divided by 128 to 128  total = 256;
			...
			char c=97; //assci value is A after to run so value is a 
			n=c;
