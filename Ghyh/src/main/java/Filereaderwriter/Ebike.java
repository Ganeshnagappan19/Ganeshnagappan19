package Filereaderwriter;
	...
	public class Ebike {
		...
		static Logger logger=Logger.getLogger(Ebike .class);
		...
		public static void main(String[] args) {
			...
			LocalTime st=LocalTime.of(hour, minute);
			
			LocalTime sts=LocalTime.of(hour, minute);
			
			if(st.getHour()<sts.getHour() || ((st.getHour()==sts.getHour()) && (st.getMinute()<sts.getMinute()))) {
			...
			if(st.getHour()>ste.getHour() || ((st.getHour()==ste.getHour()) && (st.getMinute()>ste.getMinute()))) {
